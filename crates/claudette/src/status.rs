...
impl StatusController {
    ...
    /// Model started emitting visible text — go quiet so the spinner does not
    /// collide with streamed output. Idempotent and cheap on repeat deltas.
    pub fn on_streaming(&self) {
